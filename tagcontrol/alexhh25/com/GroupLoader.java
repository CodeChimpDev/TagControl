...
class GroupLoader {
        ...
        private static LinkedHashMap<String, LinkedHashMap<String, String>> generateConfig(File target) {
                ...
                out.println("fuse.nametag.group.admin prefix = \"[&cAdmin&f] \"");
                out.println("fuse.nametag.group.mod prefix = \"[&bMod&f] \"");
                out.println("fuse.nametag.group.member prefix = \"[&eMember&f] \"");
                out.println("fuse.nametag.group.swag prefix = \"&eThe &b\"");
                out.println("fuse.nametag.group.swag suffix = \" &cSwagmaster\"");
